  ...
  return (
    <div className="bg-[#120724] border border-ast_blue/20 rounded-xl p-6">
      <div className="flex items-center justify-between mb-6">
        ...
        <span className="text-xs bg-ast_pink/20 text-ast_pink px-2 py-1 rounded">LOW STOCK</span>
      </div>
          ...
          <div key={supply.id} className="space-y-1">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <p className="text-xs text-ast_body">{supply.name}</p>
                {supply.isNew && (
              ...
              <p className="text-xs text-ast_body/60">{supply.qty} items</p>
            </div>
